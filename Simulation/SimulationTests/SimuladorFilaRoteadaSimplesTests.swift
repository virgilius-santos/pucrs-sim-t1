...
class SimuladorFilaRoteadaSimplesTests: XCTestCase {
    ...
    func test_NovoSimulador() {
        ...
        XCTAssertEqual(qs[0].contador[1], 20750.3363, accuracy: 0.0001)
        XCTAssertEqual(qs[0].contador[2], 4814.4276, accuracy: 0.0001)
        XCTAssertEqual(qs[0].contador[3], 456.7931, accuracy: 0.0001)
        XCTAssertEqual(qs[0].contador[4], 23.8438, accuracy: 0.0001)
        XCTAssertEqual(qs[0].contador[5], 0.3625, accuracy: 0.0001)
        XCTAssertEqual(qs[0].perdas, 0)
        
        
        XCTAssertEqual(qs[1].contador[0], 37.2795, accuracy: 0.0001)
        XCTAssertEqual(qs[1].contador[1], 351.3668, accuracy: 0.0001)
        XCTAssertEqual(qs[1].contador[2], 2298.9544, accuracy: 0.0001)
        XCTAssertEqual(qs[1].contador[3], 8182.9876, accuracy: 0.0001)
        XCTAssertEqual(qs[1].contador[4], 15442.3387, accuracy: 0.0001)
        XCTAssertEqual(qs[1].contador[5], 14026.7916, accuracy: 0.0001)
        XCTAssertEqual(qs[1].perdas, 4830)
        
        XCTAssertEqual(qs[2].contador[0], 15.0888, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[1], 1.9752, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[2], 1.1781, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[3], 8.0773, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[4], 34.5039, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[5], 150.5435, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[6], 2835.8364, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[7], 12830.8987, accuracy: 0.0001)
        XCTAssertEqual(qs[2].contador[8], 24461.6167, accuracy: 0.0001)
        XCTAssertEqual(qs[2].perdas, 6570)
