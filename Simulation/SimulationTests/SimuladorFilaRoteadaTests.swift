...
class SimuladorFilaRoteadaTests: XCTestCase {
    var sut: Simulador!
    ...
    func test_SimuladorExemploT1() {
        let maxIteracoes = 100_000
        sut = Simulador(
            random: .init(semente: 1, maxIteracoes: maxIteracoes),
            filas: [
                Fila(nome: "Q1",
    ...
    func test_filaRede_loopCompleto() {
        ...
        sut = Simulador(
            ...
            filas: [
                Fila(nome: "Q1",
                     kendall: .init(c: 2, k: 4, n: valoresFixos.count),
